...
The resulting drawr visualization presents horsepower against miles per gallon. Lets take a look at the plot and try for ourselves. As Emily has described it before, drawing loess regression is like giving a child a crayon and asking them to draw a line between the points on a graph.
:::
